...
ACubismMotion* CubismUserModel::LoadExpression(const csmByte* buffer, csmSizeInt size, const csmChar* name, csmFloat32 fadeTime)
{
    return CubismExpressionMotion::Create(buffer, size, fadeTime);
}
